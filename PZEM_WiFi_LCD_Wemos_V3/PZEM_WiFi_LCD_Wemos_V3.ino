...
const char* relayControlUrl = "https://www.meter.it-icc.com/relayControl.php";
String deviceId = "002"; //*** Replace with the actual device ID
...
const unsigned long relayCheckInterval = 5000; // Check relay state every 5 seconds
...
void setup() {
    ...
    // Check and set initial relay state
    checkRelayState();
}
...
void loop() {
    ...
    delay(8000); // ส่งข้อมูลทุกๆ 10 วินาที
}
    ...
    if (WiFi.status() == WL_CONNECTED) {
        ...
        if (httpResponseCode > 0) {
            ...
            if (newState != relayState) {
                ...
                display.display();
                delay(2000); // แสดงผลลัพธ์เป็นเวลา 2 วินาที
            }
        } else {
